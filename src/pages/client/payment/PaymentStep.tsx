  ...
  const content =
    paymentMethod === "cod" ? (
      <div className="max-w-xl mx-auto bg-white p-12 rounded-[2.5rem] text-center card-shadow border border-brand-gray-100 font-sans relative">
        ...
        <h2 className="text-4xl font-display text-brand-black font-extrabold mb-4 tracking-tight">
          Xác nhận đơn hàng
        </h2>
        ...
        <div className="p-8 bg-brand-gray-50 rounded-2xl border border-brand-gray-100 mb-10 flex justify-between items-center">
          <span className="text-brand-gray-900/40 font-bold uppercase tracking-widest text-xs">
            Tổng số tiền
          </span>
          <span className="text-3xl font-display font-extrabold text-brand-orange">
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start font-sans pb-10">
        ...
        <div className="bg-white p-10 rounded-3xl card-shadow border border-brand-gray-100 relative">
          <h4 className="text-lg text-brand-black font-extrabold mb-8 flex items-center gap-3 tracking-tight">
            <ImageIcon className="w-6 h-6 text-brand-orange" /> Tải hình ảnh
            thanh toán
          </h4>
          ...
          <div className="relative group">
            ...
            <label
              htmlFor="bill"
              className={cn(
                "flex flex-col items-center justify-center gap-6 rounded-2xl border-2 border-dashed transition-all cursor-pointer",
                paymentProof
      ...
      <div className="fixed bottom-0 left-0 right-0 p-6 bg-white/80 backdrop-blur-xl border-t border-brand-gray-100 z-50">
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <button
            onClick={onSubmit}
            disabled={
              isSubmitting || (paymentMethod === "transfer" && !paymentProof)
            }
