...
export const MOCK_MEAL_DATA: MenuItem[] = [
      { id: 1, weekday: "T2", mealType: "Sáng", dishName: "Protein luộc (gạo lứt)", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1779784844/PROTEINLUOC_dvzojp.png", price: 100000 },
      { id: 2, weekday: "T2", mealType: "Trưa", dishName: "Nui gạo lứt sốt nấm", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1784040953/nuigaolutgasotnam_a7fjmj.png", price: 100000 },
      { id: 3, weekday: "T2", mealType: "Chiều", dishName: "Ức gà áp chảo rau củ", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1786446113/ucgaapchaoraucu_prmth0.png", price: 100000 },

      { id: 4, weekday: "T3", mealType: "Sáng", dishName: "Salad bò (bún gạo lứt)", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1780469850/saladbo_dz1qyy.png", price: 100000 },
      { id: 5, weekday: "T3", mealType: "Trưa", dishName: "Cơm gạo lứt bò bông cải", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1785235859/comgaolutboapchao_vqrlnm.png", price: 100000 },
      { id: 6, weekday: "T3", mealType: "Chiều", dishName: "Bò áp chảo rau củ", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1781522310/boapchaobido_j985nb.png", price: 100000 },

      { id: 7, weekday: "T4", mealType: "Sáng", dishName: "Protein luộc (gạo lứt) ", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1779784844/PROTEINLUOC_dvzojp.png", price: 100000 },
      ...
      { id: 9, weekday: "T4", mealType: "Chiều", dishName: "Salad tôm trứng (bún gạo lứt)", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1779785646/saladtomtrung_ogzeul.png", price: 100000 },

      { id: 10, weekday: "T5", mealType: "Sáng", dishName: "Protein luộc (gạo lứt)", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1779784844/PROTEINLUOC_dvzojp.png", price: 100000 },
      { id: 11, weekday: "T5", mealType: "Trưa", dishName: "Bún gạo lứt cá basa", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1781522309/bungaolutchaca_nb38s8.png", price: 100000 },
      { id: 12, weekday: "T5", mealType: "Chiều", dishName: "Cá basa áp chảo", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1781522310/cabasaphileapchao_lobane.png", price: 100000 },
      ...
      { id: 15, weekday: "T6", mealType: "Chiều", dishName: "Salad ức gà (bún gạo lứt)", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1779784495/saladucga_nyoryq.png", price: 100000 },
      
      { id: 16, weekday: "T7", mealType: "Sáng", dishName: "Protein luộc (gạo lứt)", image: "https://res.cloudinary.com/dst8bybiw/image/upload/v1779784844/PROTEINLUOC_dvzojp.png", price: 100000 },
